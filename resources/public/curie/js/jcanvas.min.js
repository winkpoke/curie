...
("undefined" != typeof window ? window.jQuery : {}, "undefined" != typeof window ? window : this, function (a, b) {
    ...
    function q(a, b, c) {
        ...
        c.shadowStroke && 0 !== c.strokeWidth ? (b.stroke(), b.fill(), b.shadowColor = "transparent", b.shadowBlur = 0, b.stroke()) : (b.fill(), "transparent" !== c.fillStyle && (b.shadowColor = "transparent"), 0 !== c.strokeWidth && b.stroke()),
        c.closed || b.closePath(),
        p(b, c),
    ...
    function s(b) {
        ...
        return d._canvas === b && d._data ? c = d._data : (c = a.data(b, "jCanvas"), c || (c = {
                        ...
                        scaled: !1,
                        redrawOnMousemove: !1
                    }, a.data(b, "jCanvas", c)), d._canvas = b, d._data = c),
        c
    }
    function t(a, b, c) {
        var d;
    ...
    function B(a, b, c) {
        ...
        if (g = b.drag, e = g.layer, h = e && e.dragGroups || [], d = b.layers, "mousemove" === c || "touchmove" === c) {
            ...
            "mouseup" !== c && "touchend" !== c || (g.dragging && (e.dragging = !1, g.dragging = !1, b.redrawOnMousemove = b.originalRedrawOnMousemove, G(a, b, e, "dragstop")), b.drag = {})
    }
    function C(b, c, d) {
        var e;
    ...
    function H(b, d, f, g) {
        ...
        d.layer && !d._layer ? (h = a(b), j = s(b), k = j.layers, (null === l.name || e(l.name) && void 0 === j.layer.names[l.name]) && (i(d), l = new c(d), l.canvas = b, l.layer = !0, l._layer = !0, l._running = {}, null !== l.data ? l.data = ra({}, l.data) : l.data = {}, null !== l.groups ? l.groups = l.groups.slice(0) : l.groups = [], x(h, j, l), y(h, j, l), t(h, j, l), w(h, j, l), d._event = l._event, l._method === a.fn.drawText && h.measureText(l), null === l.index && (l.index = k.length), k.splice(l.index, 0, l), d._args = l, G(h, j, l, "add"))) : d.layer || i(d),
        l
    }
    function I(a) {
        var b,
    ...
    function M(b) {
        ...
        e = [],
        f = 1;
        return "transparent" === b ? b = "rgba(0, 0, 0, 0)" : b.match(/^([a-z]+|#[0-9a-f]+)$/gi) && (d = ka.head, c = d.style.color, d.style.color = b, b = a.css(d, "color"), d.style.color = c),
    ...
    function N(a) {
        ...
        1 !== a.start[3] || 1 !== a.end[3] ? a.now = "rgba(" + a.now.join(",") + ")" : (a.now.slice(0, 3), a.now = "rgb(" + a.now.join(",") + ")"),
    ...
    function Q(a) {
        Ia.events[a] = function (b, c) {
            ...
            f = O(e),
            c.events[e] || (f !== e ? b.bind(e + ".jCanvas " + f + ".jCanvas", d) : b.bind(e + ".jCanvas", d), c.events[e] = !0)
        }
    }
    function R(a, b, c) {
        var d,
    ...
    function T(a, b, c) {
        ...
        a.translate(-b.x, -b.y),
        c && (c.scaleX *= b.scaleX, c.scaleY *= b.scaleY)
    }
    function U(a, b, c) {
        b.translate && (b.translateX = b.translateY = b.translate),
        a.translate(b.translateX, b.translateY),
        c && (c.translateX += b.translateX, c.translateY += b.translateY)
    }
    function V(a) {
        for (; a < 0; )
            a += 2 * va;
    ...
    function $(a, b, c, d, e, f, g, h) {
        d._arrowAngleConverted || (d.arrowAngle *= c._toRad, d._arrowAngleConverted = !0),
    ...
    function aa(a, b, c, d) {
        ...
        for (e = 2, $(a, b, c, d, d.x2 + c.x, d.y2 + c.y, d.x1 + c.x, d.y1 + c.y), void 0 !== d.x1 && void 0 !== d.y1 && b.moveTo(d.x1 + c.x, d.y1 + c.y); ; ) {
            if (f = d["x" + e], g = d["y" + e], void 0 === f || void 0 === g)
                break;
    ...
    function ba(a, b, c, d) {
        ...
        for (e = 2, $(a, b, c, d, d.cx1 + c.x, d.cy1 + c.y, d.x1 + c.x, d.y1 + c.y), void 0 !== d.x1 && void 0 !== d.y1 && b.moveTo(d.x1 + c.x, d.y1 + c.y); ; ) {
            if (f = d["x" + e], g = d["y" + e], h = d["cx" + (e - 1)], i = d["cy" + (e - 1)], void 0 === f || void 0 === g || void 0 === h || void 0 === i)
                break;
    ...
    function fa(a, b, c, d) {
        ...
        for (c === d ? (h = 0, i = 0) : (h = c.x, i = c.y), e = 1, j = l = n = d.x + h, k = m = o = d.y + i, $(a, b, c, d, j + da(c, d.a1, d.l1), k + ea(c, d.a1, d.l1), j, k), void 0 !== d.x && void 0 !== d.y && b.moveTo(j, k); ; ) {
            if (f = d["a" + e], g = d["l" + e], void 0 === f || void 0 === g)
                break;
            l = n,
            m = o,
            n += da(c, f, g),
    ...
    function ia(a, b) {
        ...
        for (e = 0; e < k.length; e += 1) {
            if (f = k[e], g = f.split(" "), c = [], d = "", 1 === g.length || a.measureText(f).width < j)
                c = [f];
            else {
    ...
    a.fn.getEventHooks = function () {
        ...
        c = this,
        d = {};
        return 0 !== c.length && (a = c[0], b = s(a), d = b.eventHooks),
        d
    },
    ...
    a.fn.getLayer = function (a) {
        ...
        i = this;
        if (0 !== i.length)
            if (b = i[0], c = s(b), d = c.layers, h = ta(a), a && a.layer)
                f = a;
            else if ("number" === h)
                a < 0 && (a = d.length + a), f = d[a];
            else if ("regexp" === h) {
                for (g = 0; g < d.length; g += 1)
        ...
        if (void 0 !== b)
            for (d = 0; d < g.length; d += 1)
                if (c = a(g[d]), e = c.getLayerGroup(b))
                    for (e = e.slice(0), f = 0; f < e.length; f += 1)
                        c.removeLayer(e[f]);
        return g
    },
    ...
    a.event.fix = function (b) {
        ...
        if (b = Ca.call(a.event, b), d = b.originalEvent)
            if (e = d.changedTouches, void 0 !== b.pageX && void 0 === b.offsetX)
                ...
                try {
                    c = a(b.currentTarget).offset(),
                    c && (b.offsetX = e[0].pageX - c.left, b.offsetY = e[0].pageY - c.top)
                } catch (a) {}
        return b
    },
    Da.drawings = {
        ...
        bezier: "drawBezier",
        ellipse: "drawEllipse",
        function : "draw", image: "drawImage", line: "drawLine", path: "drawPath", polygon: "drawPolygon", slice: "drawSlice", quadratic: "drawQuadratic", rectangle: "drawRect", text: "drawText", vector: "drawVector", save: "saveCanvas", restore: "restoreCanvas", rotate: "rotateCanvas", scale: "scaleCanvas", translate: "translateCanvas"
},
...
a.fn.saveCanvas = function a(b) {
    ...
    for (d = 0; d < j.length; d += 1)
        if (e = h(j[d]))
            for (g = s(j[d]), f = new c(b), H(j[d], f, b, a), i = 0; i < f.count; i += 1)
                k(e, g);
    return j
},
...
a.fn.measureText = function (a) {
    ...
    b = h(f[0]),
    b && (ga(f[0], b, d), e = null !== d.maxWidth ? ia(b, d) : d.text.split("\n"), ha(f[0], b, d, e)),
    d
},
a.fn.drawImage = function b(d) {
    function e(a, b, c, d, e) {
        ...
        null !== d.sWidth && null !== d.sHeight && null !== d.sx && null !== d.sy ? (null === d.width && (d.width = d.sWidth), null === d.height && (d.height = d.sHeight), d.cropFromCenter && (d.sx += d.sWidth / 2, d.sy += d.sHeight / 2), d.sy - d.sHeight / 2 < 0 && (d.sy = d.sHeight / 2), d.sy + d.sHeight / 2 > q.height && (d.sy = q.height - d.sHeight / 2), d.sx - d.sWidth / 2 < 0 && (d.sx = d.sWidth / 2), d.sx + d.sWidth / 2 > q.width && (d.sx = q.width - d.sWidth / 2), r(a, b, d, d.width, d.height), n(a, b, d), b.drawImage(q, d.sx - d.sWidth / 2, d.sy - d.sHeight / 2, d.sWidth, d.sHeight, d.x - d.width / 2, d.y - d.height / 2, d.width, d.height)) : (r(a, b, d, d.width, d.height), n(a, b, d), b.drawImage(q, d.x - d.width / 2, d.y - d.height / 2, d.width, d.height)),
        b.beginPath(),
...
a.fn.createPattern = function (b) {
    ...
    m = this;
    return e = h(m[0]),
    e ? (g = new c(b), l = g.source, f(l) ? (i = a("<canvas />")[0], i.width = g.width, i.height = g.height, j = h(i), l.call(i, j), d()) : (j = l.getContext, l.src || j ? i = l : (i = new la, l.match(/^data:/i) || (i.crossOrigin = g.crossOrigin), i.src = l), i.complete || j ? d() : (i.onload = d, i.src = i.src))) : k = null,
    k
},
...
a.fn.getCanvasImage = function (a, b) {
    ...
    d = this,
    e = null;
    return 0 !== d.length && (c = d[0], c.toDataURL && (void 0 === b && (b = 1), e = c.toDataURL("image/" + a, b))),
    e
},
